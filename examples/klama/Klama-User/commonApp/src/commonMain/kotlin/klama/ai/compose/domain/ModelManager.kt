package klama.ai.compose.domain

import ai.klama.gguf.GgufMetadataReader
import klama.ai.compose.data.ModelStatus
import klama.ai.compose.data.SettingsRepository
...
class ModelManager(
    ...
    companion object {
        fun createDefault(): ModelManager {
            ...
            val engineBridge = klama.ai.compose.engine.createEngineBridge()
