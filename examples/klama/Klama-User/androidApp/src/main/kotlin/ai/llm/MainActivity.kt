...
import ai.llm.io.FilePicker
import androidx.lifecycle.lifecycleScope
import ai.llm.engine.AndroidEngineBridgeHooks
...
import ai.llm.engine.updateAndroidEngineState
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ai.llm.io.AndroidContextProvider.context = applicationContext
